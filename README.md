This repo contains the MATLAB implementation for 2 ship detection algorithm in synthetic aperture radars (SAR) images as published in the following papers:
